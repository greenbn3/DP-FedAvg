...
for dataset in datasets:
    for epsilon in epsilon_values:
        ...
        csv_filename = os.path.join(log_dir, f'{dataset}_accuracy_epsilon_{epsilon_str}.csv')
        ...
        # Read the CSV file and collect accuracies for rounds 40-150
        try:
...
plt.ylabel('Average Accuracy (%) (Rounds 40-150)')

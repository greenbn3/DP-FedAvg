...
class Client:
    def __init__(self, model, dataset, batch_size, learning_rate, device):
...
def main():
    ...
    # Create clients
    clients = [Client(model_type, dataset, batch_size=32, learning_rate=0.01, device=device) for _ in range(num_clients)]
